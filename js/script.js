...
displayBook = (data) => {
    const totalFound = document.getElementById("found");
    totalFound.innerText = `almost ${data.numFound} book found `;
    ...
    if (data.numFound === 0) {
        ...
        data?.docs.forEach((item) => {
            ...
            item?.cover_i ?
                (imgUrl = `https://covers.openlibrary.org/b/id/${item?.cover_i}-M.jpg`) : (imgUrl = "images/error.png");
